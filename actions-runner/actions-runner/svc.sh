...
SVC_NAME="actions.runner.IanaraFer-computer-infrastructure.weater-data.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (IanaraFer-computer-infrastructure.weater-data)"
