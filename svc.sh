...
SVC_NAME="actions.runner.IanaraFer-computer-infrastructure.weater-run.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (IanaraFer-computer-infrastructure.weater-run)"
